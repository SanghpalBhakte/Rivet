...
export const INITIAL_QUEUE_ITEMS: QueueItem[] = [
  ...
  },
  {
    id: 'q-102',
    type: 'job',
    title: 'Nagpur Airport Transfer — Flight AI-441',
...
export const INITIAL_RECENT_ACTIVITIES: ActivityItem[] = [
  {
    ...
    timestamp: '10:45 AM',
    title: 'Quote Sent',
    description: 'Sent revised quote #JN-892 to Rajesh Sharma (₹45,000)',
    category: 'quote',
  },
  {
    id: 'act-2',
    ...
    description: 'Pachmarhi Outstation Trip confirmed by Vikram Rao',
    category: 'lead',
  },
  {
    id: 'act-3',
    ...
    description: 'Received advance ₹15,000 via UPI from Sanjay Deshmukh',
    category: 'payment',
  },
];
